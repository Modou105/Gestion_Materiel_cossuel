        ...
        <?php
            if(isset($_POST['modifRegion'])){
              ...
              $cnx=$con->EtablirUneConnexion();
                ...
                $cnx=NULL;
            }else if(isset($_POST['modifAgent'])){
              ...
              $cnx=$con->EtablirUneConnexion();
                if($cnx!=false){
                  if(!empty($_FILES['monfichier']['name'])){
                    $req=$cnx->prepare("update agents set MatriculeAgent='$matagent', PrenomAgent='$prenomagent', NomAgent='$nomagent',AdresseAgent='$adragent',TelephoneAgent='$telagent',EmailAgent='$mailagent',PhotoAgent='$MaPhoto' where IdAgent='$idagent'");
                  }else{
                      $req=$connex->prepare("update agents set MatriculeAgent='$matagent', PrenomAgent='$prenomagent', NomAgent='$nomagent',AdresseAgent='$adragent',TelephoneAgent='$telagent',EmailAgent='$mailagent' where IdAgent='$idagent'");
                  }
                  if($req->execute()){
                      ?>
                        <script type="text/javascript">
                ...
                $cnx=$con->EtablirUneConnexion();
                if($cnx!=false){
                    $req=$cnx->prepare("insert into detailsVerification(ObjetVerification, NatureConclusion, LibelleConclusion, IdRapport) values('".strtoupper($_POST['objver'])."', '".strtoupper($_POST['natconclusion'])."','".$_POST['libconclusion']."','".$_POST['idrapp']."' )");
                    if($req->execute()){
                      ?>
                        <script type="text/javascript">
