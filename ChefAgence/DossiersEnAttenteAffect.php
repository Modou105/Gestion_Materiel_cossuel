      ...
      <div class="container-fluid">
        <div class="card card-primary">
          ...
          if(!isset($_GET['idag'])){
           ...
           ?>
           <h3 class="card-title">DEMANDES CREEES</h3>
           <?php
           }
          ?>
          </div>
        <div class="row">
           <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                    <?php
                    if(!isset($_GET['idag'])){
                      $reqDemAPayee=$connex->prepare("select dossiers.IdDossier, dossiers.NumeroDossier, dossiers.DateCreation, dossiers.HeureCreation, demandes.TypeDemande, demandes.NumeroDemande, demandes.DateDemande, proprietaires.PrenomProprietaire, proprietaires.NomProprietaire, proprietaires.AdresseProprietaire,proprietaires.TelephoneProprietaire, electriciens.PrenomElectricien, electriciens.NomElectricien, agents.MatriculeAgent, agents.PrenomAgent, agents.NomAgent from dossiers, demandes, proprietaires, electriciens, agents, agences, affectations_agents where dossiers.IdDemande=demandes.IdDemande and demandes.IdAgent=agents.IdAgent and agents.IdAgent=affectations_agents.IdAgent and affectations_agents.IdAgence=agences.IdAgence and proprietaires.IdProprietaire=demandes.IdProprietaire and electriciens.IdElectricien=demandes.IdElectricien and  agences.IdAgence='".$sess->RecuperationInformations('idagence')."' and NOT EXISTS(select* from affectations_dossiers where affectations_dossiers.IdDossier=dossiers.IdDossier)");
                    }else{
                      $reqDemAPayee=$connex->prepare("select dossiers.IdDossier, dossiers.NumeroDossier, dossiers.DateCreation, dossiers.HeureCreation, demandes.TypeDemande, demandes.NumeroDemande, demandes.DateDemande, proprietaires.PrenomProprietaire, proprietaires.NomProprietaire, proprietaires.AdresseProprietaire,proprietaires.TelephoneProprietaire, electriciens.PrenomElectricien, electriciens.NomElectricien, agents.MatriculeAgent, agents.PrenomAgent, agents.NomAgent from dossiers, demandes, proprietaires, electriciens, agents, agences, affectations_agents where dossiers.IdDemande=demandes.IdDemande and dossiers.IdAgentCree=agents.IdAgent and agents.IdAgent=affectations_agents.IdAgent and affectations_agents.IdAgence=agences.IdAgence and proprietaires.IdProprietaire=demandes.IdProprietaire and electriciens.IdElectricien=demandes.IdElectricien and  agences.IdAgence='".$sess->RecuperationInformations('idagence')."' and dossiers.IdAgentCree='".$_GET['idag']."'");
                    }
                    ...
                    ?>
                  <tr>
                    <td><?php echo $infoNombrereqDemAPayee['NumeroDossier'] ?></td>
                    <td><?php echo $infoNombrereqDemAPayee['DateCreation'] ?></td>
                    <td><?php echo $infoNombrereqDemAPayee['HeureCreation'] ?></td>
                    ...
                    <tfoot>
                      <tr>
                        <td colspan="10"><strong><font size="5">TOTAL</font></strong></td>
