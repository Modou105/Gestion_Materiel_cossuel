        ...
        <div class="row">
           <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tr>
                    ...
                    <td><?php echo html_entity_decode(utf8_encode($infoNombrereqDemAPayee['PrenomProprietaire'])).' '.html_entity_decode(utf8_encode($infoNombrereqDemAPayee['NomProprietaire'])) ?></td>
                    <td><?php echo html_entity_decode(utf8_encode($infoNombrereqDemAPayee['AdresseProprietaire'])) ?></td>
                    <td><?php echo $infoNombrereqDemAPayee['TelephoneProprietaire'] ?></td>
                    <td><?php echo $infoNombrereqDemAPayee['MatriculeAgent'] ?></td>
                    <td><?php echo html_entity_decode(utf8_encode($infoNombrereqDemAPayee['PrenomAgent'])).' '.html_entity_decode(utf8_encode($infoNombrereqDemAPayee['NomAgent'])) ?></td>
                    <?php
                      if($infoNombrereqDemAPayee['TypeDemande']=='dom'){
                    ?>
