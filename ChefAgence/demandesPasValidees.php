    ...
    <section class="content">
      <div class="container-fluid">
        <div class="card card-primary">
            ...
            <h3 class="card-title">DEMANDES EN INSTANCES DE VALIDATION</h3>
          </div>
        <div class="row">
           <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tr>
                    ...
                    <td><?php echo $infoDemAValide['DateDemande'] ?></td>
                    <td><?php echo $infoDemAValide['PrenomElectricien'].' '.$infoDemAValide['NomElectricien'] ?></td>
                    <td><?php echo $infoDemAValide['PrenomProprietaire'].' '.$infoDemAValide['NomProprietaire'] ?></td>
                    <td><?php echo $infoDemAValide['AdresseProprietaire'] ?></td>
                    <td><?php echo $infoDemAValide['TelephoneProprietaire'] ?></td>
                    <td><?php echo $infoDemAValide['MatriculeAgent'] ?></td>
                    <td><?php echo $infoDemAValide['PrenomAgent'].' '.$infoDemAValide['NomAgent'] ?></td>
                    <?php
                      if($infoDemAValide['TypeDemande']=='dom'){
                    ?>
                      <td align="center"><a href="../AfficheDemandesDom.php?iddem=<?php echo $infoDemAValide['IdDemande'] ?>"><img src="../images/ouvrir.png" width="30" height="30"> </a></td>
                    <?php
                      }else{
                    ?>
                      <td align="center"><a href="../AfficheDemandesPro.php?iddem=<?php echo $infoDemAValide['IdDemande'] ?>"><img src="../images/ouvrir.png" width="30" height="30"> </a></td>
                    <?php
                      }
                    ?>
                    </tr>
