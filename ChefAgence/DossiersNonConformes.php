    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <div class="card-header">
            <h3 class="card-title">DOSSIERS CLOTURES NON CONFORMES</h3>
          </div>
        <div class="row">
           <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tr>
                    ...
                    <?php 
                    $rechAgent=$connex->prepare("select* from agents where IdAgent='".$infoDossNonConforme['IdAgentAffectant']."'");
                    $rechAgent->execute();
