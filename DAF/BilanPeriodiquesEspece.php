 ...
 <script type="text/javascript">
    function verifIntervallaDate(date1,date2){
      ...
      if(firstdate=="" || secondeDate==""){
          ...
          window.location.href="BilanPeriodiquesEspece.php";
      }else{
        if(firstdate>secondeDate){
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <form action="BilanPeriodiquesEspece.php" method="POST" name="frmRech" onsubmit="verifIntervallaDate(frmRech.datedebut.value,frmRech.datefin.value)">
                  <table>
                    <tr>
