 ...
 <script type="text/javascript">
    function verifIntervallaDate(date1,date2){
      ...
      if(firstdate=="" || secondeDate==""){
          ...
          window.location.href="BilanPeriodiquesCheques.php";
      }else{
        if(firstdate>secondeDate){
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <form action="BilanPeriodiquesCheques.php" method="POST" name="frmRech" onsubmit="verifIntervallaDate(frmRech.datedebut.value,frmRech.datefin.value)">
                  <table>
                    <tr>
              ...
              <div class="card-body">
                <?php
                  if(isset($_POST['aff']) && !empty($_POST['datedebut']) && !empty($_POST['datefin'])){
                      echo '<h5><strong>JOURNAL DES ENCAISSEMENTS PAR CHEQUES du '.DateFr($_POST['datedebut']).'    au '.DateFr($_POST['datefin']).'</strong></h5>';
                  }
                ?>
