 ...
 <script type="text/javascript">
    function verifIntervallaDate(date1,date2){
      ...
      if(firstdate=="" || secondeDate==""){
          ...
          window.location.href="demandesAnnulees.php";
      }else{
        if(firstdate>secondeDate){
 ...
 <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Liste des demandes annulées(D.A.F.)</h1>
          </div>
          <div class="col-sm-6">
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <form action="demandesAnnulees.php" method="POST" name="frmRech" onsubmit="verifIntervallaDate(frmRech.datedebut.value,frmRech.datefin.value)">
                  <table>
                    <tr>
