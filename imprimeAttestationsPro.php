...
$pdf->Cell(0,5,'USAGE PROFESSIONNEL',0,0,'C');
...
$pdf->SetFont('Arial','B',10);
$pdf->Cell(120,5,html_entity_decode($resultInfo['PrenomElectricien']).' '.html_entity_decode($resultInfo['NomElectricien']),0,0);
