            ...
            <form action="valideEnreg.php" method="post">
              <div class="card-body">
                <div class="form-group">
                  ...
                  <input type="date" name="datevisite" class="form-control"  placeholder="Entrez la date prévue pour la visite" required>
                </div>
              </div>
              <div class="card-body">
                <div class="form-group">
                  <label for="">Heure Visite</label>
                  <input type="time" name="heurevisite" class="form-control"  placeholder="Entrez l'heure prévue pour la visite" required>
                </div>
              </div>
              <div class="card-body">
                <div class="form-group">
                  <label for=""></label>
                  <input type="hidden" name="iddossier" class="form-control" value="<?php echo $_GET['iddossier'] ?>">
                </div>
              </div>
            <div class="card-footer">
              <button type="submit" name="enregPlanning" class="btn btn-primary">Enregistrer</button>
            </div>
            </form> 
        </div>
      </div>
