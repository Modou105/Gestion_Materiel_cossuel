...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="container-fluid">
		  	<h5 class="mb-2 mt-4">Choisir un type de rapport</h5>
        <div class="row">

          <?php
            $req=$connex->prepare("select* from rapports order by LibelleRapport");
            $req->execute();
           ...
           <div class="col-md-3 col-sm-6 col-12">
            <div class="info-box">
              ...
              <div class="info-box-content">
                <span class="info-box-text"><strong><?php echo $info['LibelleRapport'] ?></strong></span>
                <span class="info-box-number"><a href="visites.php?iddem=<?php echo $_GET['iddem'] ?>&idvisite=<?php echo $_GET['idvisite'] ?>&idrapp=<?php echo $info['IdRapport'] ?>">Choisir</a></span>
              </div>
              <!-- /.info-box-content -->
            </div>
            <!-- /.info-box -->
