        ...
        <div class="card card-primary">
          <div class="card-header">
            ...
            <div class="card-body">
              <div class="form-group">
                <label for="exampleInputEmail1">Nom de la région</label>
                <?php
              if(isset($_GET['idreg'])){
                if($cnx!=false){
                    $req=$cnx->prepare("select* from regions where IdRegion='".$_GET['idreg']."'");
                    $req->execute();
                    $inforeg=$req->fetch();
                ?>
                <input type="text" name="nomreg" class="form-control" id="exampleInputName" value="<?php echo $inforeg['NomRegion'] ?>" required>
                <input type="hidden" name="idreg" class="form-control"  value="<?php echo $inforeg['IdRegion'] ?>" required>
                <?php
				$cnx=NULL;
              }
              }else{
                ?>
                <input type="text" name="nomreg" class="form-control" id="exampleInputName" placeholder="Enter le nom de la nouvelle région" required>
                <?php
              }
            ?>
              </div>
          ...
          <div class="card-footer">
            <?php
              if(isset($_GET['idreg'])){
                ?>
                <button type="submit" name="modifRegion" class="btn btn-primary">Modifier</button>
                <?php
              }else{
                ?>
                <button type="submit" name="enregRegion" class="btn btn-primary">Enregistrer</button>
                <?php
              }
            ?>
          </div>
