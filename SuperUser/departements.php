      ...
      <div class="card card-primary">
          ...
          <?php
            ...
            <div class="card-body">
              <div class="form-group">
                <label for="exampleInputNom">Nom du département</label>
                 <?php
              if(isset($_GET['iddep'])){
                if($cnx!=false){
                    $req=$cnx->prepare("select* from departements where IdDepartement='".$_GET['iddep']."'");
                    $req->execute();
                    $inforeg=$req->fetch();
                ?>
                <input type="text" name="nomdep" class="form-control" id="exampleInputName" value="<?php echo $inforeg['NomDepartement'] ?>" required>
                <input type="hidden" name="iddep" class="form-control"  value="<?php echo $inforeg['IdDepartement'] ?>" required>
                <?php
				$cnx=NULL;
              }
              }else{
                ?>
                <input type="text" name="nomdep" class="form-control" id="exampleInputName" placeholder="Enter le nom du département" required>
                <?php
              }
            ?>
              </div>
              <div class="form-group">
                <?php
                  if(isset($_GET['iddep'])){
                    ?>
                      <input type="hidden" name="idreg" class="form-control" id="exampleInputName" required>
                    <?php
                  }else{
                    ?>
                      <input type="hidden" name="idreg" class="form-control" id="exampleInputName" value="<?php echo $_GET['idreg'] ?>" required>
                    <?php
                  }
                ?>
          ...
          <div class="card-footer">
            <?php
              if(isset($_GET['iddep'])){
                ?>
                <button type="submit" name="modifDepartement" class="btn btn-primary">Modifier</button>
                <?php
              }else{
                ?>
                <button type="submit" name="enregDepartement" class="btn btn-primary">Enregistrer</button>
                <?php
              }
            ?>
          </div>
