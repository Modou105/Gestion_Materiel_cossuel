                ...
                ?>
                  ...
                  <?php
                    if (isset($_GET['idagent']) && isset($_GET['idagence'])){
                      ...
                      echo'<br/>';
                      echo "<strong>à l'agence de: ".$infosAgence['NomAgence']."  comme superviseur ? </strong>";
                      ?>
                  ...
                  <div class="tab-pane" id="newcompte">
                    <form class="form-horizontal" action="valideEnreg.php" method="post">
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                          <input type="password" name="pwd" class="form-control"  placeholder="Entrez votre mot de passe" required>
                        </div>
                      </div>
                      <div class="form-group row">
                        <label  class="col-sm-2 col-form-label">Confirmation</label>
                        <div class="col-sm-10">
                          <input type="password" name="confpwd" class="form-control"  placeholder="Confirmez votre mot de passe" required>
                        </div>
                      </div>
                      <div class="form-group row">
