        ...
        <div class="card card-primary">
          <div class="card-header">
            ...
            <div class="card-body">
              <div class="form-group">
                <label for="exampleInputEmail1">Libelle Rapport</label>
                <?php
              if(isset($_GET['idrapp'])){
                if($cnx!=false){
                    $req=$cnx->prepare("select* from rapports where IdRapport='".$_GET['idrapp']."'");
                    $req->execute();
                    $inforapp=$req->fetch();
                ?>
                <input type="text" name="librapp" class="form-control" id="exampleInputName" value="<?php echo $inforapp['LibelleRapport'] ?>" required>
                <input type="hidden" name="idrapp" class="form-control"  value="<?php echo $inforapp['IdRapport'] ?>" required>
                <?php
				$cnx=NULL;
              }
              }else{
                ?>
                <input type="text" name="librapp" class="form-control" id="exampleInputName" placeholder="Enter le nom de la nouvelle région" required>
                <?php
              }
            ?>
              </div>
          ...
          <div class="card-footer">
            <?php
              if(isset($_GET['idrapp'])){
                ?>
                <button type="submit" name="modifRapport" class="btn btn-primary">Modifier</button>
                <?php
              }else{
                ?>
                <button type="submit" name="enregRapport" class="btn btn-primary">Enregistrer</button>
                <?php
              }
            ?>
          </div>
